...
public class UserPageGeneratorManager {
    ...
    private static UserPageGeneratorManager userPageGeneratorManager;

    private UserPageGeneratorManager() {

    }

    public synchronized static UserPageGeneratorManager getUserPageGeneratorManager() {
        if (userPageGeneratorManager == null) {
            return new UserPageGeneratorManager();
        }
        return userPageGeneratorManager;
    }
